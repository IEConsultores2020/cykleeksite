!function () {
            ...
            e = setTimeout(() => {
                !function (e) {
                    ...
                    Array.from(document.querySelectorAll(".navbar-dropdown")).forEach((e) => {
                        if (e.matches(".navbar-fixed-top")) {
                            if (e.matches(".transparent") && !e.classList.contains("opened")) {
    ...
    document.querySelector("html").classList.contains("is-builder") || document.addEventListener("click", function (e) {
        ...
        if ((window.matchMedia("(max-width: 1166px)").matches || s) && (n && !t.closest(".navbar-collapse") || r)) {
    ...
    document.querySelectorAll(".navbar-dropdown .dropdown-menu .dropdown-item").forEach((item) => {
        item.addEventListener("click", () => {
            let dropdown = item.closest(".navbar-dropdown");
            if (dropdown) {
                let toggler = dropdown.querySelector(".navbar-toggler");
